...
set :application_name, 'mina_demoapp'
set :domain, 'mina-demoapp.com'
set :deploy_to, '/var/www/mina-demoapp.com'
set :repository, 'git@github.com:computalya/mina_demoapp.git'
set :branch, 'master'
